...
func (_q *UserQuery) QueryCars() *CarQuery {
...
func (_q *UserQuery) loadCars(ctx context.Context, query *CarQuery, nodes []*User, init func(*User), assign func(*User, *Car)) error {
